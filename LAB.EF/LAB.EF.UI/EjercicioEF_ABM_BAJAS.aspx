<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="EjercicioEF_ABM_BAJAS.aspx.cs" Inherits="LAB.EF.UI.Ejercicio_ABM_BAJAS" %>
    ...
    <section>
        <div class="container-fluid mt-5">
            ...
            <div class="form-group forms mb-5">
                ...
                <asp:DropDownList runat="server" ID="ddEmpleadosBajas" CssClass="form-control" >
